...
#    info_file = get_package_share_directory("aroco_description") + "/config/aroco.yaml"
#    urdf_file = get_package_share_directory("aroco_description") + "/urdf/aroco.urdf.xacro"
#    controller_manager_yaml_file = get_package_share_directory("aroco_bringup") + "/config/controller_manager.yaml"
...
#            PathJoinSubstitution(
#                [
#                    FindPackageShare("aroco_description"),
#                    "urdf",
#                    "aroco.urdf.xacro",
#                ]
#            ),
...
#        package="gazebo_ros",
#        executable="spawn_entity.py",
#        arguments=["-topic", "robot_description", "-entity", "aroco"],
#        output="screen",
#    )
