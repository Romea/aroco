...
//-----------------------------------------------------------------------------
hardware_interface::return_type ArocoHardware::load_info_(const hardware_interface::HardwareInfo & hardware_info)
{
  try {
...
bool ArocoHardware::send_data_(uint32_t id)
{
  ...
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("ArocoHardware"),
...
//-----------------------------------------------------------------------------
void ArocoHardware::encode_odo_data_(float data1,
                                      float data2)
{
...
//-----------------------------------------------------------------------------
void ArocoHardware::decode_odo_data_(std::atomic<float> & data1,
...
void ArocoHardware::decode_front_wheel_speeds_()
{
  ...
  RCLCPP_DEBUG_STREAM(rclcpp::get_logger("ArocoHardware"),
...
{
  decode_odo_data_(rear_axle_steering_angle_measure_,
...
{
  debug_file_.open(std::string("aroco.dat").c_str(),
